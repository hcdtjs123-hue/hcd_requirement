  ...
  <div class="mx-auto flex max-w-7xl flex-col gap-8 text-gray-900">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <h1 class="mt-3 text-3xl font-semibold tracking-tight">Candidate Management</h1>
        <p class="mt-2 text-sm text-gray-600">
          Sortir kandidat, kirim credential, monitoring pengisian form, dan jadwalkan interview.
        </p>
      </div>
      <button
        type="button"
        ...
        <div class="rounded-3xl border border-gray-200 bg-gray-50 p-5">
          ...
          <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
              ...
              <option v-for="opt in statusOptions" :key="opt" :value="opt">{{ invStatusLabel(opt as CandidateInvitationStatus) }}</option>
            </select>
          </div>
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-left text-sm text-gray-600">
                ...
                >
                  ...
                  <td class="px-4 py-3 align-middle">
                    <span class="inline-flex rounded-full bg-gray-100 px-2.5 py-0.5 text-[10px] tracking-wider text-gray-600">
                  ...
                  <td class="px-4 py-3 align-middle">
                    ...
                    <div class="flex flex-col">
                      ...
                      <p class="mt-1 whitespace-nowrap text-[10px] text-gray-400">{{ inv.form_progress }}%</p>
                    </div>
                  </td>
                  <td class="px-4 py-3 text-right align-middle">
                    <RowActionsMenu
                      :actions="[
                        { label: 'Proses / Detail', onClick: () => goToEdit(inv.id) },
                      ]"
                    />
                  </td>
                </tr>
...
const totalPages = computed(() => Math.max(1, Math.ceil(filteredInvitations.value.length / pageSize)))
...
function goToCreate() {
  router.push("/candidate-management/create")
}

function goToEdit(id: string) {
  router.push(`/candidate-management/${id}/edit`)
}
