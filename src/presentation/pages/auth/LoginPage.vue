<template>
  <main class="relative min-h-screen overflow-hidden bg-gray-50 text-gray-900">
    ...
    <div
      class="relative mx-auto grid min-h-screen max-w-6xl items-center gap-10 px-6 py-10 lg:grid-cols-[1.1fr_0.9fr]"
    >
      <section class="hidden lg:block">
        ...
        <h1 class="mt-6 max-w-xl text-6xl font-semibold leading-none tracking-tight">
          Sign in to a more organized recruitment workspace.
        </h1>
      </section>
      ...
      >
        ...
        <Form class="space-y-5" @submit="onSubmit">
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700" for="identifier"
...
async function onSubmit(
  ...
  actions: { setErrors: (errors: Record<string, string>) => void },
) {
