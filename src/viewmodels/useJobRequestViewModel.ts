...
export function useJobRequestViewModel() {
  ...
  async function refresh() {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : "Gagal memuat job request."
    } finally {
      loading.value = false
    }
  }
  ...
  async function create(payload: JobRequestInput) {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : "Gagal membuat job request."
      throw err
    } finally {
      saving.value = false
    }
  ...
  async function update(id: string, payload: JobRequestInput) {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : "Gagal memperbarui job request."
      throw err
    } finally {
      saving.value = false
    }
  ...
  async function remove(id: string) {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : "Gagal menghapus job request."
      throw err
    } finally {
      saving.value = false
    }
