...
export function useApproverMasterViewModel() {
  ...
  async function refresh() {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to load approver data.'
    } finally {
      loading.value = false
    }
  }
  ...
  async function create(data: ApproverMasterInput) {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to add the approver.'
      throw err
    } finally {
      saving.value = false
    }
  ...
  async function update(id: string, data: ApproverMasterInput) {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to update the approver.'
      throw err
    } finally {
      saving.value = false
    }
  ...
  async function remove(id: string) {
    ...
    try {
      ...
      error.value = err instanceof Error ? err.message : 'Failed to delete the approver.'
      throw err
    } finally {
      saving.value = false
    }
