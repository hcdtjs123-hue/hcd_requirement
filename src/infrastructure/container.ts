...
import { CandidateRepositoryImpl } from "@/infrastructure/supabase/repositories/CandidateRepositoryImpl"
...
export const candidateRepo = new CandidateRepositoryImpl()
