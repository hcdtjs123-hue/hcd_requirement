  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'employee-request-forms',
          component: () => import('@/presentation/pages/employeeRequestForms/EmployeeRequestFormList.vue'),
          meta: { requiredPermissions: ['employee_request_form:read'] },
        },
        {
          path: 'employee-request-forms/create',
          name: 'employee-request-forms-create',
          component: () => import('@/presentation/pages/employeeRequestForms/EmployeeRequestFormPage.vue'),
          meta: { requiredPermissions: ['employee_request_form:create'] },
        },
        {
          path: 'employee-request-forms/:id',
          name: 'employee-request-forms-detail',
          component: () => import('@/presentation/pages/employeeRequestForms/EmployeeRequestFormPage.vue'),
          meta: { requiredPermissions: ['employee_request_form:read'] },
        },
        {
          path: 'employee-request-forms/:id/edit',
          name: 'employee-request-forms-edit',
          component: () => import('@/presentation/pages/employeeRequestForms/EmployeeRequestFormPage.vue'),
          meta: { requiredPermissions: ['employee_request_form:update'] },
        },
        {
          path: 'candidate-forms',
          name: 'candidate-forms',
          component: () => import('@/presentation/pages/candidateForms/CandidateFormList.vue'),
          meta: { requiredPermissions: ['candidate_form:read'] },
        },
        {
          path: 'candidate-forms/create',
          name: 'candidate-forms-create',
          component: () => import('@/presentation/pages/candidateForms/CandidateFormPage.vue'),
          meta: { requiredPermissions: ['candidate_form:create'] },
        },
        {
          path: 'candidate-forms/:id/edit',
          name: 'candidate-forms-edit',
          component: () => import('@/presentation/pages/candidateForms/CandidateFormPage.vue'),
          meta: { requiredPermissions: ['candidate_form:update'] },
        },
        {
          path: 'job-requests',
          redirect: '/employee-request-forms',
        },
        {
          path: 'job-requests/create',
          redirect: '/employee-request-forms/create',
        },
        {
          path: 'job-requests/:id',
          redirect: (to) => `/employee-request-forms/${to.params.id}`,
        },
        {
          path: 'job-requests/:id/edit',
          redirect: (to) => `/employee-request-forms/${to.params.id}/edit`,
        },
        {
          path: 'candidates',
          redirect: '/candidate-forms',
        },
        {
          path: 'candidates/create',
          redirect: '/candidate-forms/create',
        },
        {
          path: 'candidates/:id/edit',
          redirect: (to) => `/candidate-forms/${to.params.id}/edit`,
        },
        {
          path: 'applications',
          redirect: '/candidate-forms',
        ...
        // Recruitment Routes
        {
          ...
          meta: { requiredPermissions: ['recruitment:read', 'candidate_form:read'] },
        },
        {
